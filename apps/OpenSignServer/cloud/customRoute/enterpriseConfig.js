...
export const DEFAULT_MESSAGE_DB_PATH = path.resolve('data/enterprise-messages.sqlite');
...
export function getEnterpriseConfig() {
  return {
    ...
    messageDbPath:
      process.env.ENTERPRISE_MESSAGE_BOARD_DB ||
      process.env.ENTERPRISE_MESSAGE_BOARD_FILE ||
      DEFAULT_MESSAGE_DB_PATH,
